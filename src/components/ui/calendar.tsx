        ...
        Day: (props) => {
          ...
          return (
            <div className="relative">
              {dataSource.length > 0 ? (
                <span className="absolute top-0.5 right-0.5 grid min-h-1 min-w-1 translate-x-1/2 -translate-y-1/2 rounded-full bg-red-600 py-1 px-1 text-xs text-white"></span>
              ) : null}
              <Day {...props} />
            </div>
          )
